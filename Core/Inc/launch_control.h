...
#define LC_CROSSOVER_SPEED_MS   49.0f
#define LC_EXIT_SPEED_MS        49.0f

// Minimum throttle position to trigger launch. Driver gotta be rlly bout it
#define LC_THROTTLE_TRIGGER     0.30f

#define LC_KP                   49.0f
#define LC_KI                   49.0f

#define LC_SLIP_RATE_MAX        49.0f
#define LC_SLIP_RATE_CUT_MULT   0.3f
